...
\caption{per-class violation probability for four placement rules (TAS scheduling).}
\label{fig:hetero}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.49\columnwidth}
...
\label{fig:bcd}
\end{subfigure}
\caption{Tail-aware placement with two critical users ($h=4$, $\delta=10^{-6}$) and six regular users.}
\label{fig:placement}
\end{figure}
%%DISC-PLACEMENT%%

\subsection{Reconfiguration Delay and Power--Tail Trade-off}
\begin{figure}[t]
\centering
\begin{subfigure}[t]{0.49\columnwidth}
\includegraphics[width=\linewidth]{fig_tau}
\caption{versus the reconfiguration delay $\tau_r$.}
\label{fig:tau}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.49\columnwidth}
\includegraphics[width=\linewidth]{fig_V}
\caption{power--tail trade-off of TLA-SWAN for increasing $V$.}
\label{fig:V}
\end{subfigure}
\caption{Cost of reactive repositioning and the trade-off controlled by the penalty parameter $V$.}
\label{fig:tauV}
\end{figure}
%%DISC-TAUV%%
